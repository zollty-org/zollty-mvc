...
同样，还有58同城开源的轻量级Web框架Argo，同时期在OSChina开源的JFinal，主打特点是极速、简单、方便，目前已经被业界广泛使用。
...
ZolltyMVC相比其他框架，没有历史包袱，要足够简单、实用、高效，所以在这些方面下足了功夫。
  ...
  2.  ZolltyMVC要足够快，那就要有更快的URI匹配算法，Spring采用的AntPathMather还是太慢了，我花了很多脑细胞，写出来了一个全新的URI匹配算法，命名为ZolltyPathMather，比经典的AntPathMather快几倍！
