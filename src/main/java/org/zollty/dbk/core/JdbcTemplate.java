...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	 ...
	 * @see org.zollty.dbk.SQLWarningException
	 * @see #handleWarnings
	 */
	...
	public int[] batchUpdate(final String[] sql) throws DataAccessException {
		...
		class BatchUpdateStatementCallback implements StatementCallback<int[]>, SqlProvider {
			...
			public int[] doInStatement(Statement stmt) throws SQLException, DataAccessException {
				...
				if (JdbcUtils.supportsBatchUpdates(stmt.getConnection())) {
					...
					try {
						...
						if (SpringUtils.hasLength(batchExceptionSql)) {
			...
			private String appendSql(String sql, String statement) {
				return ((sql == null || "".equals(sql)) ? statement : sql + "; " + statement);
			}
   ...
   @Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.zollty.dbk.core.JdbcOperations#batchUpdate(java.lang.String, java.util.Collection, int, org.zollty.dbk.core.ParameterizedPreparedStatementSetter)
	 *
	 ...
	 * @see #setMaxRows
	 * @see #setQueryTimeout
	 * @see org.zollty.dbk.datasource.DataSourceUtils#applyTransactionTimeout
	 */
