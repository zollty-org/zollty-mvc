...
import org.zollty.dbk.IncorrectResultSetColumnCountException;
...
public class SingleColumnRowMapper<T> implements RowMapper<T> {
	 ...
	 * @see org.zollty.dbk.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see org.zollty.dbk.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int)
	 */
