...
public class SQLErrorCodesFactory {
	 ...
	 */
	public static final String SQL_ERROR_CODE_DEFAULT_PATH = "org/zollty/dbk/support/sql-error-codes.xml";
	...
	protected SQLErrorCodesFactory() {
		...
		try {
			...
			List<BeanDefinition> beanslist = new XmlBeanReader( 
					...
					SQL_ERROR_CODE_DEFAULT_PATH ).loadBeanDefinitions();
...
//			}
			...
			SQLErrorCodesMapHolder sqlECHolder = sbf.getBean("sqlECHolder");
			errorCodes = sqlECHolder.getErrorCodesMap();//bdr.getBeansOfType(SQLErrorCodes.class, true, false);
