 ...
 * appropriate {@link org.zollty.dbk.support.nativejdbc.NativeJdbcExtractor}
...
public class OracleLobHandler extends AbstractLobHandler {
	 ...
	 * @see org.zollty.dbk.support.nativejdbc.NativeJdbcExtractor#getNativeConnectionFromStatement
	 * @see org.zollty.dbk.support.nativejdbc.SimpleNativeJdbcExtractor
	 * @see org.zollty.dbk.support.nativejdbc.OracleJdbc4NativeJdbcExtractor
	 */
			...
			if (binaryStream != null) {
				Blob blob = (Blob) createLob(ps, false, new LobCallback() {
					...
					public void populateLob(Object lob) throws Exception {
						...
						SpringUtils.copy(binaryStream, out);
					}
				});
				ps.setBlob(paramIndex, blob);
				if (logger.isDebugEnabled()) {
			...
			if (content != null) {
				Clob clob = (Clob) createLob(ps, true, new LobCallback() {
					...
					public void populateLob(Object lob) throws Exception {
						...
						SpringUtils.copy(content, writer);
					}
				});
			...
			if (asciiStream != null) {
				Clob clob = (Clob) createLob(ps, true, new LobCallback() {
					...
					public void populateLob(Object lob) throws Exception {
						...
						OutputStream out = (OutputStream) methodToInvoke.invoke(lob, (Object[]) null);
						SpringUtils.copy(asciiStream, out);
					}
				});
				ps.setClob(paramIndex, clob);
				if (logger.isDebugEnabled()) {
			...
			if (characterStream != null) {
				Clob clob = (Clob) createLob(ps, true, new LobCallback() {
					...
					public void populateLob(Object lob) throws Exception {
						Method methodToInvoke = lob.getClass().getMethod("getCharacterOutputStream", (Class[]) null);
						Writer writer = (Writer) methodToInvoke.invoke(lob, (Object[]) null);
						SpringUtils.copy(characterStream, writer);
					}
				});
				ps.setClob(paramIndex, clob);
				if (logger.isDebugEnabled()) {
